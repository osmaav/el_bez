      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="text-sm text-center sm:text-left">
            <p className="mb-1">
              © Сайт разработан в 2026г
              <a
                href="https://t.me/osmaav"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-yellow-500 transition-colors inline-flex items-center gap-1 ml-1"
              >
                osmaav
                <svg
              ...
              <span className="ml-1">для собственного ребенка</span>
            </p>
          </div>
          ...
          <div className="flex gap-4 text-sm">
            <a
              href="https://github.com/osmaav/el_bez"
              target="_blank"
              rel="noopener noreferrer"
