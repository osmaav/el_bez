            ...
            <div className="space-y-4 max-h-[500px] overflow-y-auto">
              {trainerQuestions.map((q, idx) => {
                ...
                return (
                  <div
                    key={q.id}
                    className={`p-4 rounded-lg border ${!isAnswered ? 'bg-slate-50 border-slate-200' :
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-4 md:grid-cols-4 gap-2 mb-2">
          <Card className="bg-slate-900 text-white py-2">
            <CardContent className="p-0" >
              <div className="flex items-center justify-between px-4">
                <div>
                  <p className="text-slate-400 text-xs">Всего</p>
                  <p className="text-xl font-bold">{trainerStats.total}</p>
                </div>
                <BarChart3 className="w-6 h-6 text-slate-500" />
              </div>
            </CardContent>
          </Card>
          <Card className="bg-green-600 text-white py-2">
            <CardContent className="p-0" >
              <div className="flex items-center justify-between px-4">
                <div>
                  <p className="text-green-100 text-xs">Верных</p>
                  <p className="text-xl font-bold">{trainerStats.correct}</p>
                </div>
                <CheckCircle2 className="w-6 h-6 text-green-300" />
              </div>
            </CardContent>
          </Card>
          <Card className="bg-red-600 text-white py-2">
            <CardContent className="p-0" >
              <div className="flex items-center justify-between px-4">
                <div>
                  <p className="text-red-100 text-xs">Ошибок</p>
                  <p className="text-xl font-bold">{trainerStats.incorrect}</p>
                </div>
                <XCircle className="w-6 h-6 text-red-300" />
              </div>
            </CardContent>
          </Card>
          <Card className="bg-yellow-500 text-slate-900 py-2">
            <CardContent className="p-0" >
              <div className="flex items-center justify-between px-4">
                <div>
                  <p className="text-yellow-800 text-xs">Осталось</p>
                  <p className="text-xl font-bold">{trainerStats.remaining}</p>
                </div>
